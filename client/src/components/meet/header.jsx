...
export default function Header() {
    return (
        <div className="font-mono flex justify-between items-center p-6 pb-2">
            <img alt="kjh" src={'/meet/logo.png'} className="bg-white hover:scale-125 m-2 transition duration-500 ease-in-out" height={50} width={50} />
            <div className="flex items-center justify-between w-full px-6">
                ...
                <div className="flex items-center text-white w-[200px] justify-between">
                    ...
                    <div className="h-fit px-3 flex hover:scale-110 transition duration-300 ease-in-out p-2 bg-red-500 items-center rounded-full">
                        <div className="border-4 bg-red-500 border-white h-4 w-4 mx-1 rounded-full"></div>
